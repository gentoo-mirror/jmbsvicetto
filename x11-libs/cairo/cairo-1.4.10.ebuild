...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/cairo/cairo-1.4.10.ebuild,v 1.8 2007/08/25 13:55:07 vapier Exp $
...
SRC_URI="http://cairographics.org/releases/${P}.tar.gz
	newspr? ( http://distfiles.gentoo-xeffects.org/newspr/${PN}-1.4.8-newspr.patch.bz2 )"
