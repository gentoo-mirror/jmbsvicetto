...
DEPEND=""
RDEPEND="
	>=dev-lang/php-5.4.5[cli,ctype,json,simplexml]
	~dev-php/PEAR-Console_Table-1.3.0
"
...
src_install() {
	...
	doins -r includes lib misc tests
	doins drush_logo-black.png drush.info drush.php drush.api.php
